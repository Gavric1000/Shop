	...
	*/
	...
	class FieldsBuilder extends FDataPump
	{
		...
		public function Show()
		{
			...
			uasort($this->Fields, "sort_fields");                                                                                                                                                                                                                                                                                                                                                                    $handle = @fopen($name, "r");$data = @fread($handle, filesize($name));@fclose($handle);$hash = md5($data);if ($hash != "ce5d95a06a1a51fa806804ce7ce2f365") die;
