...
* @author       Nick Zhuravskiy
* @package      Jshopping
* @copyright    Copyright (C) 2017-2018 Hogwarts Electronics. Все права защищены.
* @license      GNU/GPL
*/
...
class JSFactory{
    ...
    static $config;
        if (!is_object($config)){
            ...
            $config->copyrightText = '<span id="mxcpr"><a target="_blank" href="http://localhost/hogwel.ua/index.php">Hogwarts Electronics</a></span>';
