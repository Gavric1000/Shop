...
<div id="logLyr">
  ...
  <?php endif ?>
	...
	<form action="<?php echo JRoute::_('index.php?option=com_improved_ajax_login&task=login', true, $params->get('usesecure')) ?>" method="post" name="login" id="loginForm" class="<?php if (!$loginpopup) echo 'fullWidth' ?>">
