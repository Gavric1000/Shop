...
<?php if ($guest): // LOGIN ?>
  ...
  <?php endif ?>
	...
	<?php if ($allowreg = $usersConfig->get('allowUserRegistration')): // REGISTRATION ?>
  ...
  <?php endif ?>
    ...
    <div class="loginWndInside">
      ...
      <?php if ($allowreg && @$module->view != 'reg' && ($regp[0] == 'joomla' || @$_SESSION['oauth']['twitter'])) require dirname(__FILE__).'/reg25.php' // REGISTER FORM ?>
    </div>
	</div>
