        ...
        (function(){
            djConfig = {
              modulePaths: {
                "dojo": "/hogwel.ua/plugins/system/dojoloader/dojo/1.6.1/dojo",
                "dijit": "/hogwel.ua/plugins/system/dojoloader/dojo/1.6.1/dijit",
                "dojox": "/hogwel.ua/plugins/system/dojoloader/dojo/1.6.1/dojox"
              }
...
dojo.addOnLoad(function(){
  var params = {
    isGuest: 1,
    oauth: {},
    bgOpacity: '60|*|http://localhost/hogwel.ua//modules/mod_improved_ajax_login/themes/elegant/images/samples/ptrn1.png|*|'.match(/\d+/)[0]/100.,
    returnUrl: '/hogwel.ua/index.php?option=com_jshopping&controller=category&task=&category_id=&manufacturer_id=&label_id=&vendor_id=&page=&price_from=&price_to=&product_id=&Itemid=117',
    border: 'ded5f2|*|3|*|fc9802|*|7|*|'.split('|*|')[1].split('||')[0],
    ...
    dur: 250,
    timeout: 5000,
    userLng: 'Логин / E-mail',
    passLng: 'Пароль',
    base: 'http://localhost/hogwel.ua/',
    theme: 'elegant',
    socialProfile: 1? '/hogwel.ua/index.php?option=com_users&amp;view=profile&amp;layout=edit' : '',
    socialType: 'socialIco',
    cssPath: '/hogwel.ua/modules/mod_improved_ajax_login/cache/90-langru-RU/082362c1b5cf46a8e3097cc714bb1a6c.css',
    regPage: 'joomla',
